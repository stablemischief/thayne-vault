...
imported: 2026-04-07
---
# Farm Calendar — Sprout & Spindle

This file is checked daily during heartbeats. Add any farm task, treatment, or scheduled event here.
Format: `YYYY-MM-DD | Category | Task | Notes`

---

## Upcoming Tasks

| Due Date | Category | Task | Animal/Area | Notes |
|---|---|---|---|---|
...
| Frequency | Category | Task | Notes |
|---|---|---|---|
| Daily | 🐑 Sheep | Visual health check — eating, alert, moving normally | Both ewes |
| Daily | 🐑 Sheep | Fresh water check — scrub buckets | |
| Daily | 🐓 Chickens | Feed + water check | Layers + chicks |
| Weekly | 🐑 Sheep | Spot check FAMACHA if any ewe looks off | |
| Every 2 weeks (Apr–Oct) | 🐑 Sheep | FAMACHA score both ewes | Warm season schedule |
| Monthly (Nov–Mar) | 🐑 Sheep | FAMACHA score both ewes | Cool season schedule |
| Every 6–8 weeks | 🐑 Sheep | Hoof inspection + trim if needed | |
| Weekly | 🌱 Greenhouse | Water seedlings; check for leggy/light issues | |
| Weekly | 🌱 Greenhouse | Spray Garrett Juice on path/mulch | 8 tbsp/gallon |
...
| 2026-03-06 | 🌱 Pasture | Grass + wildflower seed broadcast | Meadow + apiary areas |
| 2026-03-06 | 🐝 Bees | Medium box added to both B colonies | Foundation work begun |
| 2026-03-06 | 🐓 Chickens | 19 chicks moved to coop brooder | ~4 weeks old at time |
