...
- **TN apiary registration (Apr 22)** — James shared TN Dept of Agriculture AP registration image in #bees. Session reset before processing. Image at `thayne-vault/inbox/2026-04-22/111933_image.png` — needs to be read and recorded next interactive session.
...
- **AI image/video generation research (Apr 22, updated Apr 23)** — GPT Image 2 (launched Apr 21) is top pick for reference-based editing/inpainting. Research saved to `drafts/active/ai-image-video-research-2026-04-22.md`. **James approved skill build** — focus on GPT + Gemini tools. Skill at `.claude/skills/ai-image-video-generation.md` not yet started. Glasses-removal family photo edit pending.
