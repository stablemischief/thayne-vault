...
## Personal
- [[Projects/Farm/3d-printer-laser-engraver]] — Bambu Lab H2S Laser Full Combo ($2,099); farm utility + kids education; full accessories/software/exhaust plan documented; pending LLC formation + purchase
- [[entities/personal/sprout-spindle]] — Chickens, Icelandic ewes (CDT Dose 2 ✓ complete ~Apr 18-19; deworming still pending postpartum — fecal egg count needed), bees, garden. Corn: two 45' rows going in ~Apr 18–25; interseeding crimson clover + cowpeas. Seedlings (cucumbers, cucamelons, peppers, tomatoes, broccoli) in greenhouse with N deficiency + leggy growth; Garrett Juice @ 1oz/gal bottom-watering is current intervention. Lavender planned for south edge of greenhouse — plant 18–24" beyond drip line, raised bed 4–6" for drainage. **Lambing 2026-04-19 (Easter):** Ewe 11 = 5yr experienced mom (twins: ram lamb + ewe lamb); Evie = first-time mom (single ewe lamb). All 3 lambs confirmed nursing mid-morning. Supplies on hand: NurseMate Colostrum powder, Producer's Pride Colostrum Gel (single-dose, IgGs + probiotics), Premier1 Quick Start (mix w/ milk replacer — NOT water), Lamb & Kid Milk replacer. BO-SE = vet Rx required (TSC won't carry). CPC Sheep 15 Licks mineral tub: safe for free-choice overnight barn access. **Greenhouse beds:** 2× side beds 4'×50', 1× center bed 8'×50', 1× outside bed ~3'×30' (carrots/beets). **Vermicomposting (Apr 22):** 1000 red wigglers (Uncle Jim's) purchased; proportional distribution by bed area (225/225/450/100). **Strawberry hanging bag project (Apr 23):** Grow strawberries in hanging bags from greenhouse pipes (not beds). Everbearing/day-neutral varieties. Seed saving from store-bought berries (Farm Fresh Kentucky) — blender extraction, cold stratification 2–3 wks. Timeline: freeze seeds now → start indoors Dec/Jan → transplant spring 2027.
...
- [[entities/personal/jessie-health]] — Jessie's full health profile: concussion/POTS/MCAS history, triggers, 7-phase protocol, supplement tiers. Vault file created Apr 25.
...
- **Post-lambing status (Apr 19, updated Apr 23)** — CDT Dose 2 confirmed given Apr 19 ✓. One female lamb had pasty butt, treated. Co-op supply run done. Nursing feed rates: Ewe 11 (twins) 1–1.5 lbs/day 16% pellet; Evie 0.75–1 lb/day. Free-choice loose mineral critical (TN selenium deficiency). Still pending: birth records → sheep-health-log.md; BO-SE vet Rx; alfalfa + orchardgrass hay suitability unanswered. Mineral: Co-Op Supreme Sheep Mineral straight; do NOT mix with Premier 1 Trace Mix (double-dose selenium risk).
...
- **TN apiary registration (Apr 22, completed Apr 24)** — Case ID `44371c27` registered with TN Dept of Agriculture. Saved to Sprout & Spindle entity file in vault.
- **6 Archon audit briefs drafted (Apr 22)** — Performance Engineer, Systems Reliability, Memory Architect, Knowledge & Learning Architect, Security & Integrity, Product Strategist. All analysis-only. Saved to `drafts/active/archon-audit-briefs-2026-04-11.md`. Awaiting James's explicit approval to dispatch.
- **AI image/video generation skills (Apr 22, completed Apr 24)** — Split into two skills: `ai-image-generation` and `ai-video-generation` at `.claude/skills/`. Built from 519-line research draft. Key facts: Sora is dead (OpenAI shutdown Mar 24 2026); GPT Image 2 does NOT support transparency (use `gpt-image-1`); all GPT Image models return base64 only; Veo 3.1 supports up to 60s/4K at $0.75/sec. Glasses-removal family photo edit still pending.
- **5-agent memory improvement analysis (Apr 23)** — HIGH PRIORITY. James wants Memory Architect, Systems Reliability, Product Strategist, Knowledge & Learning, Security & Integrity agents to analyze Thayne repo + MemPalace + Cole's latest. Briefs NOT drafted (session reset). Key research done: MemPalace uses verbatim-first ChromaDB (verbatim > summaries for retrieval); Cole uses pre-compiled markdown wiki, 3-mention threshold, heartbeat state diffing.
- **Top 2 operational fixes (Apr 23)** — (1) Rebuild memory index (still empty). (2) Add heartbeat state diffing to stop re-alerting on same calendar events every 30 min.
- **OpenClaw off the table (Apr 23)** — James explicitly said it's dangerous technology. Do not use, reference, or build with it.
